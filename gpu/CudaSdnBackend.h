...
/*
    CudaSdnBackend — native CUDA execution of the GPU SDN reverb (Windows /
    NVIDIA twin of MetalSdnBackend). Same method surface, NVRTC-compiled kernel,
...
class CudaSdnBackend
{
public:
    explicit CudaSdnBackend (int deviceIndex = 0);
    ~CudaSdnBackend();

    CudaSdnBackend (const CudaSdnBackend&) = delete;
    CudaSdnBackend& operator= (const CudaSdnBackend&) = delete;
...
using spatcore::gpu::CudaSdnBackend;
